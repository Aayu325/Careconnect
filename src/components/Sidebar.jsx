...
// import { FaClipboardList } from "react-icons/fa"; // Import icon for Patients List
...
const Sidebar = () => {
  ...
  const Sidebar_Links = [
    { id: 1, path: '/Staff-Login/Dashboard/overview', name: "Overview", icon: MdDashboard },
    { id: 2, path: '/Staff-Login/Dashboard/opdq', name: "OPDQ", icon: FaStethoscope },
    { id: 3, path: '/Staff-Login/Dashboard/bedalot', name: "BED allotment", icon: FaBed },
    { id: 4, path: '/Staff-Login/Dashboard/notices', name: "Notices", icon: MdInventory2 },
    // { id: 5, path: '/patients', name: "Patients List", icon: FaClipboardList },
  ];
